...
public class CrawlComponentStatusService {
  ...
  private final SmtpVisitRepository smtpRepository;
  private final ContentCrawlResultRepository mupetsepository;
  private final WappalyzerResultRepository wappalyzerRepository;

  public CrawlComponentStatusService(RequestRepository requestRepository, SmtpVisitRepository smtpRepository, ContentCrawlResultRepository mupetsepository, WappalyzerResultRepository wappalyzerRepository) {
  ...
  public CrawlComponentStatus getCrawlComponentStatus(UUID visitId) throws ExecutionException, InterruptedException {
    ...
    return new CrawlComponentStatus(visitId,
      ...
      smtpVisitEntity.map(result -> result.getCrawlStatus() == CrawlStatus.OK).orElse(false),
