  ...
  stages {
    ...
    stage("Build and push docker images") {
      steps {
        script {
          def docker = [:]
          ["dispatcher", "dns-crawler", "smtp-crawler", "vat-crawler", "feature-extraction", "content-crawler", "ground-truth", "mercator-api", "muppets", "ssl-crawler", "mercator-ui", "mercator-wappalyzer"].each { app ->
//             docker[app] = {
