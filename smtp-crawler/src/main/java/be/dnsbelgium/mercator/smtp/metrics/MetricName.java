...
public interface MetricName {
    ...
    // The time between sending EHLO and receivng a response
    String TIMER_EHLO_RESPONSE_RECEIVED    = "smtp.analyzer.ehlo.response.received";

    // The time between sending STARTTLS and receivng a response
    String TIMER_STARTTLS_COMPLETED        = "smtp.analyzer.starttls.completed";

    // The time between sending QUIT and receivng a response
    ...
    // number of IP's that were skipped (because IPv6, loopback, ...)
