...
import static be.dnsbelgium.mercator.web.metrics.MetricName.COUNTER_WEB_CRAWLS_DONE;
...
public class WebCrawler {
    ...
    @Setter
    @Value("${web.crawler.persist.page.visits:false}")
    private boolean persistPageVisits = false;

    @Setter
    @Value("${web.crawler.persist.first.page.visit:false}")
    ...
    private HtmlFeatures findFeatures(VisitRequest visitRequest, Page page) {
        ...
        try {
            ...
            logger.debug("findFeatures took {} millis", millis);
        }
    }
