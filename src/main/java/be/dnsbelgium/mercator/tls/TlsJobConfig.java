...
public class TlsJobConfig {
  ...
  @Value("${tls.virtualThreads:false}")
  ...
  public AsyncTaskExecutor tlsTaskExecutor() {
    ...
    if (virtualThreads) {
      logger.info("TLS: using a VirtualThreadTaskExecutor, chunkSize={}", chunkSize);
    ...
    logger.info("TLS: executor corePoolSize={} maxPoolSize={} chunkSize={}", corePoolSize, maxPoolSize, chunkSize);
    return executor;
  }
