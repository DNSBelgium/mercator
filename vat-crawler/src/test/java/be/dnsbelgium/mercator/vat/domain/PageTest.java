...
class PageTest {
  ...
  public void asPageVisitWithoutBodyText() {
    VisitRequest visitRequest = new VisitRequest(UUID.randomUUID(), "abc.be");
    ...
    assertThat(pageVisit.getId()).isNull();
  ...
  public void skipBinaryData() {
    ...
    VisitRequest visitRequest = new VisitRequest(UUID.randomUUID(), "test.be");
    PageVisit pageVisit = page.asPageVisit(visitRequest, true);
