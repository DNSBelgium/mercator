...
public class HtmlFeatureExtractor {
  ...
  public HtmlFeatures extractFromHtml(String rawHtml, String url, String domainName) {
    ...
    return extractFromHtml(inputStream, url, domainName);
  }
   ...
   * see https://jsoup.org/apidocs/org/jsoup/Jsoup.html#parse(java.io.File,java.lang.String,java.lang.String)
   *
  ...
  public HtmlFeatures extractFromHtml(InputStream inputStream, String charsetName, String url, String dn) {
    ...
    try {
      ...
      if (metaDescription != null) {
        String mdesc = metaDescription.attr("content");
        features.nb_meta_desc = mdesc.split(" ").length;
        features.meta_text += mdesc + " ";
      }
    } catch (Throwable t) {
  ...
  private void processSocialMediaLinks(HtmlFeatures features, Document document) {
    ...
    logger.debug("Done searching social media links for {} \n" +
  ...
  /**
   * Determine the language(s) of a Jsoup Document using https://github.com/pemistahl/lingua
  ...
  public int getMaxLinksSocial() {
    return maxLinksSocial;
  }
