...
import {checkObjectIsFalsy, differenceBetweenTwoDates} from "../../services/Util";
...
const TLSCard = (props) => {
    ...
    useEffect(() => {
        const handlerData = async () => {
            ...
            try {
                ...
                if (crawlResultResponse.length === 0) {
                    setErrorMessages(errorMessages => [...errorMessages, "No crawl data found for this visit."]);
                }
            } catch (e) {
                handleError(e, "crawl");
            }
    ...
    const csvToP = (csv) => {
        ...
        return <div>{array.map((x, i) => {
            return <p key={i} className="m-0 p-0">{x}</p>
        })}</div>;
    }
    ...
    const renderXCheck = (bool) => {
        ...
        if (bool) {
            ...
            drawing = "M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z";
        }
        else {
            className = "bi bi-check";
            //https://icons.getbootstrap.com/icons/check/
            drawing = "M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z";
        }
        return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                ...
                                <Card.Body>
                                    <div className="tls-table">
                                        ...
                                        <Table size="sm" borderless>
                                            ...
                                            : "No scan data was found for this crawl result"}
                                    </div>
